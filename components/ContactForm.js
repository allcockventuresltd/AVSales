...
export default function ContactForm() {
  ...
  return (
    <form className="form" onSubmit={handleSubmit} noValidate aria-label="Contact form">
      ...
      {status === 'error' && (
        <p className="form__error visible">Something went wrong. Please email us directly at <a href="mailto:hello@avsalesconsultancy.co.uk">hello@avsalesconsultancy.co.uk</a></p>
      )}
